"""
[INPUT]: pytest-bdd, unittest.mock, athenaclaw.integrations.market.finnhub
...
def _make_adapter(mock_client: MagicMock):
    from athenaclaw.integrations.market.finnhub import FinnhubAdapter, finnhub

    with patch.object(finnhub, "Client", return_value=mock_client):
