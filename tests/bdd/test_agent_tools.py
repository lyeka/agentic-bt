...
def given_workspace(tmp_path):
    ...
    from athenaclaw.tools.filesystem.read import register as reg_read
    from athenaclaw.tools.filesystem.write import register as reg_write
    from athenaclaw.tools.filesystem.edit import register as reg_edit
    from athenaclaw.tools.shell.tool import register as reg_bash
