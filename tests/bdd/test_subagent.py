...
from athenaclaw.subagents import SubAgentDef, SubAgentResult, filter_schemas, run_subagent, _msg_to_dict
from athenaclaw.subagents import (
    SubAgentSystem,
...
from athenaclaw.runtime import _wire_trace
...
_PROJECT_SUBAGENT_DIR = Path(__file__).resolve().parents[2] / ".agents" / "subagents"
