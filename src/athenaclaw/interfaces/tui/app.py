"""
[INPUT]: textual, threading, time, datetime, athenaclaw.kernel, athenaclaw.runtime, athenaclaw.interfaces.tui.{widgets,sidebar,commands,screens}
...
from athenaclaw.interfaces.tui.commands import AppCommandProvider
from athenaclaw.interfaces.tui.sidebar import SidebarPanel
from athenaclaw.interfaces.tui.widgets import StreamingMarkdown
from athenaclaw.kernel import Session
from athenaclaw.runtime import KernelBundle
...
class InvestmentApp(App):
    ...
    def _make_confirm(self) -> Callable[[str], bool]:
        from athenaclaw.interfaces.tui.screens import ConfirmScreen
